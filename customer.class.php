...
class Customer { 
    ...
    function list_records() {
        ...
        echo "
            ...
            <body>
                <a href='https://github.com/ajsliter/Prog02' target='_blank'>Github</a><br />
                <div class='container'>
                    <p class='row'>
                        <h3>$this->title" . "s" . "</h3>
                    </p>
        ...
        echo "
                ...
                <a href='img/Prog02%20UML%20Class%20Diagram.png' target='_blank'>UML Class Diagram</a>
                <br></br>
                <a href='Prog02UserFlow.htm' target='_blank'>User Flow Diagram</a>
            </body>
